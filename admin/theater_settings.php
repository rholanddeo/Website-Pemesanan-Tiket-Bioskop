...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12">
			<button class="btn btn-block btn-sm btn-primary col-sm-2" type="button" id="new_theater"><i class="fa fa-plus"></i> Theater Baru</button>
			<button class="btn btn-block btn-sm btn-primary col-sm-2" type="button" id="new_group"><i class="fa fa-plus"></i> Grup Tempat Duduk</button>
		</div>
	</div>
	<div class="row">
						 	...
						 	<td>
								...
								<div class="btn-group">
								  ...
								  <div class="dropdown-menu">
								    ...
								    <a class="dropdown-item delete_theater" href="javascript:void(0)" data-id = '<?php echo $row['id'] ?>'>Hapus</a>
								  </div>
								</div>
								</center>
						 	</td>
	...
	<div class="card col-md-7 mt-3 ml-3">
			<div class="card-header">
				<large>Group Tempat Duduk</large>
			</div>
			<div class="card-body">
				<table class="table table-bordered">
					<thead>
						 	...
						 	<td>
								...
								<div class="btn-group">
								  ...
								  <div class="dropdown-menu">
								    ...
								    <div class="dropdown-divider"></div>
								    <a class="dropdown-item delete_seat" href="javascript:void(0)" data-id = '<?php echo $row['id'] ?>'>Hapus</a>
								  </div>
								</div>
								</center>
						 	</td>
