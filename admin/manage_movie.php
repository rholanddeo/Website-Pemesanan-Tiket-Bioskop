...
<div class="container-fluid">
	<div class="col-lg-12">
		<form id="manage-movie">
			...
			<div class="form-group">
				<label for="" class="control-label">Harga Tiket</label>
				<input type="text" name="price" required="" class="form-control" value="<?php echo isset($meta['price']) ? $meta['price'] : '' ?>">
			</div>
			<div class="form-group row">
				<label for="" class="control-label col-md-12">Durasi</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Jadwal Tayang</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Tanggal Akhir Penayangan</label>
