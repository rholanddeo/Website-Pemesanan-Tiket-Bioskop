 				...
 				<div class="col-md-8">
 					<div class="card bg-primary">
 						<div class="card-body text-white">
 							...
 							<hr>
 							<p class=""><small><b>Deskripsi: </b><i><?php echo $mov['description'] ?></i></small></p>
 							<p class=""><small><b>Durasi: </b><i><?php echo $duration ?></i></small></p>
							 <p class=""><small><b>Harga Tiket: </b><i><?php echo $mov['price'] ?></i></small></p>
 						</div>
 					</div>
 					<div class="card bg-light mt-2">
 						<div class="card-body">
 							<h4>Pesan Tiket Anda Disini</h4>
 							<form action="" id="save-reserve">
 								...
 								<div class="row">
 									<button class="col-md-2 btn btn-block btn-primary">Pesan</button>
 								</div>
 							</form>
	...
	$(document).ready(function(){
		$('#save-reserve').submit(function(){
			...
			$.ajax({
				...
				success:function(resp){
					if(resp == 1){
						alert("Tiket Berhasil Dipesan, silahkan datang ke loket bioskop21, 30 menit sebelum jadwal penayangan, untuk melakukan pembayaran dengan menyebutkan nama dan kontak anda !");
